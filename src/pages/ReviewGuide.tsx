...
export default function ReviewGuide() {
  return (
    <GuidePage><GuideHeader title="PR 리뷰 주고받기" duration="약 15분">리뷰는 변경의 목적과 동작을 팀원이 함께 확인하는 과정입니다. <br/> 리뷰 요청부터 피드백 반영과 승인까지 주고받아봅시다.</GuideHeader><GuideBody reading><section>
          ...
          <GuideScreenshot src={`${import.meta.env.BASE_URL}pull_request.png`} width={1778} height={1650} alt="GitHub의 카카오 로그인 구현 PR 화면: main과 feat/kakao-login 브랜치, 변경 내용, 관련 이슈, 검증 결과와 리뷰 참고 사항을 확인하는 예시. 새 탭에서 원본 이미지 보기." loading="lazy" placement="inline" />
        </section><section>
