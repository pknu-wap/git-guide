export default function DevelopmentGuide() {
  return (
    <div className="page development-guide">
      ...
      <div className="instructions">
        <section>
          ...
          <div className="concept-grid">
            ...
            <div><h3>원격 · GitHub</h3><p>Push팀원들과 Commit을 공유하는 곳입니다.</p></div>
          </div>
        ...
        <section>
          <h2 className="step-title"><span className="step-number">3</span>Branch로 작업 공간 나누기</h2>
          ...
          <p className="example">예시: develop에서 docs/readme-setup을 생성 → README 수정 → 리뷰 후 develop에 합치기</p>
        </section>

        <section>
          <h2 className="step-title"><span className="step-number">4</span>Diff를 확인하고 Commit 만들기</h2>
        ...
        <section>
          <h2 className="step-title"><span className="step-number">5</span>Push로 팀원에게 공유하기</h2>
        ...
        <section>
          <h2 className="step-title"><span className="step-number">6</span>Pull Request로 리뷰받고 Merge하기</h2>
        ...
        <section>
          <h2 className="step-title"><span className="step-number">7</span>충돌 해결과 변경 이력 확인</h2>
        ...
        <section>
          <h2 className="step-title"><span className="step-number">8</span>작은 변경 하나로 연습하기</h2>
      ...
      <a className="button guide-next" href="?guide=clone">← 이전 가이드: 팀의 레포지토리 복제하기</a>
    </div>
  )
}
